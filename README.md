...
```javascript
import incrcovariance from 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-incr-covariance@v0.1.0-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/stats-incr-covariance/actions/workflows/test.yml/badge.svg?branch=v0.1.0
[test-url]: https://github.com/stdlib-js/stats-incr-covariance/actions/workflows/test.yml?query=branch:v0.1.0
